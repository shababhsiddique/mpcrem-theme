...
//        document.getElementById("muted").innerHTML = muted === -1 ? "X" : muted === 1 ? "M" : "&nbsp;&nbsp;";
        document.getElementById("mute-state").className = muted === -1 ? "glyphicon glyphicon-volume-up" : muted === 1 ? "glyphicon glyphicon-volume-off" : "glyphicon glyphicon-volume-up";
